          ...
          <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a class="btn btn-warning " href="{{url('/bandara/'. $table->id_bandara .'/edit')}}"><i class="glyphicon glyphicon-pencil"></i>Edit</a>
                  <form action="{{url('/bandara',$table->id_bandara)}}" method="delete">
